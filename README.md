...
Tipos de Código (/tipo-codigo): Aquí defines qué tipo de etiqueta física vas a pegarle al equipo. Puedes registrar tipos como "Código de Barras", "Código QR" o "RFID".
